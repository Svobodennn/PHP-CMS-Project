            ...
            <form id="customer">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="customerCompany" name="customerCompany" placeholder="Enter customer company">
                    </div>
                    <div class="form-group">
                        <label for="customerMail">Customer Mail</label>
                        <input type="email" class="form-control" id="customerMail" name="customerMail" placeholder="Enter customer mail">
                    </div>
                    <div class="form-group">
